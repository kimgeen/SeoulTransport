...
<body>
<form action="train_search_load">
<div class="main-body">
    <div class="main-selection">
        <div class="selection-name">
            <span>서울시 지하철 경로검색</span>
        </div> 
        <div class="selection-explain">
            <span>지도에서 출발지와 목적지를 클릭한 후 검색하시면 지하철 경로검색이 가능합니다.</span>
        </div>
    </div>
    <input type="submit" value="검색하기">
    <input type="button" value="초기화" onclick="location.href='train_search_load_map'";>
